...
public class Main extends Application {
    ...
    public Stage login(){
        ...
        GridPane root = new GridPane();  //creating groups of nodes

        Label fName = new Label("First Name");
        Label lName = new Label("Last Name");
        Label pin_code = new Label("Pin Code");
        Label create_account = new Label("Don't have an account ? ");

        Label wrong_PinCode = new Label();
        Label wrong_LastName = new Label();
        Label wrong_FirstName = new Label();
        ...
        root.addRow(0,title);
        root.add(fName,50,10);
        root.addRow(3,lName,lNameText);
        root.addRow(4,pin_code,code);
        root.addRow(5,create_account,createAccount);
                ...
                if(temp.getFirstName().equals(first_name)){
                    if(temp.getLastName().equals(last_name)){
                        if(temp.getPincode().equals(user_code)){
                            ...
                            employeeMenu_stage.show();

                        }

                        else{
                            wrong_PinCode.setText("Incorrect Password . Please try again");
                        }
                    }
                    else{
                        wrong_LastName.setText("Incorrect Last Name. Please try again");
                    }
                }
                else{
                    wrong_FirstName.setText("Incorrect First Name. Please try again");
                }
    ...
    public  Stage employeeOptions(){

        Text title = new Text();
        title.setText("Choose Any Options");
        title.setX(120);
        title.setY(120);
        ...
        return employeeMenu_stage;

    }

    public Stage managerOptions(){
